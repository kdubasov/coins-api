...
export const GL_MKCH_24H = `market_cap_change_24h`;
...
//exchanges
export const GL_EXC_BASE = 'base';
export const GL_EXC_TRD_URL = 'trade_url';
export const GL_EXH_CN_ID = 'coin_id';
...
export const GL_EXC_SPR = 'bid_ask_spread';
...
export const GL_LAST_TRD = 'last_traded';

//Derivatives
export const GL_OP_INT_BTC = 'open_interest_btc';
export const GL_OP_INT_USD = 'open_interest_usd';
...
export const GL_PER_DEL_TICK = 'h24_percentage_change';
